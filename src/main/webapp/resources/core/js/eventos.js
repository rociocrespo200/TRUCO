...
function registrarEvento(evento) {
    ...
    let div_bloquear = document.getElementById("bloquear");

    (eventoEnProceso === true) ? div_bloquear.style.display = "flex" : div_bloquear.style.display = "none";
