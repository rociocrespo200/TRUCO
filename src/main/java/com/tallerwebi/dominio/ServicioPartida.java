...
public class ServicioPartida {
    ...
    public void registrarEvento(DatosEvento evento) { repositorioPartida.registrarEvento(evento);
    }

    public Evento obtenerUltimoEvento() {return repositorioPartida.obtenerUltimoEvento();}
}
